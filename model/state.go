...
const (
	...
	// describe_all not supported now
...
func init() {
	...
	State1Actions = append(State1Actions, ActionsUpscale...)
	...
	State4Actions = append(State4Actions, ActionsUpscale...)
